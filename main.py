...
async def compare_proposals(files: List[UploadFile] = File(...)):
    ...
    for idx, file in enumerate(files):
        ...
        extraction_prompt = f"""
        You are a procurement intelligence AI. Analyze the following vendor proposal text and extract the key information.
    ...
    comparison_prompt = f"""
    You are an executive procurement advisor. Review the following structured data extracted from multiple vendor proposals.
    Generate a comparative summary and recommendation.
